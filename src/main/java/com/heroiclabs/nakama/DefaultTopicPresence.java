...
public class DefaultTopicPresence implements TopicPresence {
    ...
    static DefaultTopicPresence fromProto(final @NonNull com.heroiclabs.nakama.Api.TopicPresence topicPresence) {
        ...
        for (com.heroiclabs.nakama.Api.UserPresence u : topicPresence.getLeavesList()) {
            leaves.add(DefaultUserPresence.fromProto(u));
        }

        return new DefaultTopicPresence(DefaultTopicId.fromProto(topicPresence.getTopic()), joins, leaves);
    }
}
