...
public interface MatchmakerMatchedOrBuilder extends
   ...
   */
  java.util.List<com.heroiclabs.nakama.realtime.MatchmakerMatched.MatchmakerUser> 
      getUsersList();
  /**
   * <pre>
   * The users that have been matched together, and information about their matchmaking data.
   ...
   * <code>repeated .nakama.realtime.MatchmakerMatched.MatchmakerUser users = 4 [json_name = "users"];</code>
   */
  com.heroiclabs.nakama.realtime.MatchmakerMatched.MatchmakerUser getUsers(int index);
  /**
   * <pre>
   * The users that have been matched together, and information about their matchmaking data.
   * </pre>
   ...
   * <code>repeated .nakama.realtime.MatchmakerMatched.MatchmakerUser users = 4 [json_name = "users"];</code>
   */
  java.util.List<? extends com.heroiclabs.nakama.realtime.MatchmakerMatched.MatchmakerUserOrBuilder> 
   ...
   * <code>repeated .nakama.realtime.MatchmakerMatched.MatchmakerUser users = 4 [json_name = "users"];</code>
   */
  com.heroiclabs.nakama.realtime.MatchmakerMatched.MatchmakerUserOrBuilder getUsersOrBuilder(
      int index);
   ...
   * @return The self.
   */
  com.heroiclabs.nakama.realtime.MatchmakerMatched.MatchmakerUser getSelf();
  /**
   * <pre>
   * A reference to the current user and their properties.
   * </pre>
   ...
   * <code>.nakama.realtime.MatchmakerMatched.MatchmakerUser self = 5 [json_name = "self"];</code>
   */
  com.heroiclabs.nakama.realtime.MatchmakerMatched.MatchmakerUserOrBuilder getSelfOrBuilder();

  com.heroiclabs.nakama.realtime.MatchmakerMatched.IdCase getIdCase();
}
