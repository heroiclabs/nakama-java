...
public interface GetMessageListResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:satori.api.GetMessageListResponse)
   ...
   */
  java.util.List<com.heroiclabs.satori.api.Message> 
      getMessagesList();
  /**
   * <pre>
   * The list of messages.
   ...
   * <code>repeated .satori.api.Message messages = 1 [json_name = "messages"];</code>
   */
  com.heroiclabs.satori.api.Message getMessages(int index);
  /**
   * <pre>
   * The list of messages.
   * </pre>
   ...
   * <code>repeated .satori.api.Message messages = 1 [json_name = "messages"];</code>
   */
  java.util.List<? extends com.heroiclabs.satori.api.MessageOrBuilder> 
   ...
   * <code>repeated .satori.api.Message messages = 1 [json_name = "messages"];</code>
   */
  com.heroiclabs.satori.api.MessageOrBuilder getMessagesOrBuilder(
      int index);
