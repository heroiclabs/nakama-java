...
public class FriendsRemoveMessageTest {
    ...
    @Test
    public void friendsRemoveNotFound() throws Exception {
        FriendsRemoveMessage remove = FriendsRemoveMessage.Builder.newBuilder().id(UUID.randomUUID().toString()).build();
        final Deferred<Boolean> deferred = client1.send(remove);
    ...
    @Test
    public void friendsRemoveRequest() throws Exception {
        ...
        deferred.addCallbackDeferring(new Callback<Deferred<Boolean>, Boolean>() {
            ...
            public Deferred<Boolean> call(Boolean success) throws Exception {
                FriendsRemoveMessage remove = FriendsRemoveMessage.Builder.newBuilder().id(session2.getId()).build();
                return client1.send(remove);
            }
    ...
    @Test
    public void friendsRemoveMutual() throws Exception {
